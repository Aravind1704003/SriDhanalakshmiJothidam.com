...
const ServicePage = () => {
  ...
  return (
    ...
    <div className="bg-cover bg-center bg-gray-100 py-10 min-h-screen" style={{ backgroundImage: 'url("/background1.jpg")' }}>
